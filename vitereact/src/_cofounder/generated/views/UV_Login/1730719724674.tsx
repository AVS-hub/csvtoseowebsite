...
const UV_Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const resultAction = await dispatch(login_user({ email, password }));
      if (login_user.fulfilled.match(resultAction)) {
        navigate('/dashboard');
      } else {
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" onClick={initiatePasswordReset} className="font-medium text-indigo-600 hover:text-indigo-500">
